...
class Connexion {
	private $PARAM_hote = '192.168.151.23'; // le chemin vers le serveur local (pour les tests) ou serveur de production (sur la ferme)
	private $PARAM_utilisateur = 'Francis'; // nom d'utilisateur pour se connecter
	private $PARAM_mot_passe = 'Jacques'; // mot de passe de l'utilisateur pour se connecter
