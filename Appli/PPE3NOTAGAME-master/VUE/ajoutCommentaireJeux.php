...
$pageIndex->contenu = '<section>
		...
		<fieldset>
				...
				<div>
					<span>Choisir un jeu vid&eacute;o : </span><br/><label><Select name=nomJV id = nomJV>';
...
foreach ($listeJV as $unJV){
	// pour TESTER : echo "UN JEUX VIDEO : </br>";print_r($unJV);
				...
				/*'<input class="validate[required] radio" type="radio"  name="radioJV"  id="' . $unJV->IDJV. '"  value="' . $unJV->IDJV. '" /><span class="radio">' . $unJV->NOMJV . '-' .$unJV->ANNEESORTIE.'</span>';*/
}
